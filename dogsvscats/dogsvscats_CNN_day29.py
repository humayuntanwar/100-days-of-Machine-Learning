...
MODEL_NAME = 'dogsvscats-{}-{}.model'.format(LR, '2conv-basic') #to save the model
...
# train_data = np.load(trian_data.npy)
...
# convnet = regression(convnet,optimizer='atom',learning_rate=LR, loss='categorical_crossentropy', name='targets')
